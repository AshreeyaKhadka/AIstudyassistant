            ...
            <div className="signin-features-wrapper">
              ...
              >
                ...
                <div className="flex items-center gap-3 border-t border-white/10 pt-4">
                  ...
                  <span className="text-xs font-semibold tracking-wider text-slate-400 uppercase">— B.B. King</span>
                </div>
              </motion.div>
            </div>
          </div>
          <div className="signin-form-pane">
            ...
            >
              ...
              <div className="signin-header">
                <h1 className="signin-title text-slate-800">Welcome back</h1>
                <p className="signin-subtitle text-slate-400">Log in to continue your learning journey.</p>
              </div>
              ...
              <div className="signup-prompt-premium text-slate-400">
                ...
                <Link to="/signup" className="signup-link-premium text-blue-600 font-bold hover:underline">Register here</Link>
              </div>
            </motion.div>
          </div>
        </div>
